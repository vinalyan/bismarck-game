...
// ВАЖНО: Этот файл содержит только функции для ОТОБРАЖЕНИЯ и ВИЗУАЛИЗАЦИИ карты.
// Все расчеты расстояний движения, валидация и бизнес-логика выполняются на бэкенде.
