...
export const MAP_CONSTANTS = {
  ...
  MARGIN_LEFT: 500,         // Центрирование гексов на подложке
  MARGIN_TOP: 1000,         // Центрирование гексов на подложке
  MARGIN_RIGHT: 500,        // Симметричный отступ
  MARGIN_BOTTOM: 1000       // Симметричный отступ
};
