...
export const MAP_CONSTANTS = {
  ...
  BACKGROUND_WIDTH: 8419,   // Оригинальная ширина подложки
  BACKGROUND_HEIGHT: 7146,  // Оригинальная высота подложки
  
  // Размеры гексагональной сетки
  HEX_GRID_WIDTH: 35,     // 35 гексов по горизонтали
  HEX_GRID_HEIGHT: 33,    // 33 гекса по вертикали (A-Z, AA-AG)
  
  // Стандартный радиус гекса
  DEFAULT_HEX_RADIUS: 40,
  
  // Отступы от краев карты (рассчитаны для полной подложки)
  MARGIN_LEFT: 280,         // Центрирование гексов на подложке
  MARGIN_TOP: 240,         // Центрирование гексов на подложке
  MARGIN_RIGHT: -55,        // Симметричный отступ
  MARGIN_BOTTOM: 20       // Симметричный отступ
};
